...
from typing import Any, Dict, Iterator, List, Optional, Tuple, Union, Callable, TypeVar
...
from allennlp.common import Lazy, Registrable, Tqdm, Params
...
@Trainer.register("gradient_descent_modified", constructor="from_partial_objects")
class GradientDescentTrainer(Trainer):
    ...
    def from_params(cls, 
        ...
        **extras) -> 'GradientDescentTrainer':
#         token_indexers = TokenIndexer.dict_from_params(params.pop('token_indexers', {}))
        validation_metric = params.pop('validation_metric', "+f1_measure")
        return GradientDescentTrainer(validation_metric=validation_metric)