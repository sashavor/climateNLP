# code adapted from:
# https://github.com/allenai/allennlp-bert-qa-wrapper/blob/master/pretrained_bert/model.py#L48-L74
...
from pytorch_ptrained_bert.tokenization import BasicTokenizer
